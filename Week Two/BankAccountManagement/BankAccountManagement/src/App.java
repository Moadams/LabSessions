...
public class App extends Application {
    ...
    public void start(Stage initialStage){
        ...
        //Layout setup
        VBox layout = new VBox(5); // sets the space arround the children of the vbox
        layout.setPadding(new javafx.geometry.Insets(20)); // padding for each element
        layout.getChildren().addAll(
            customerNameLabel, customerNameTextField, accountNumberLabel, accountNumberTextField, accountTypeLabel, accountTypeComboBox, createAccountButton
        );
        ...
        layout.getChildren().addAll(
            amountLabel, amountField, transactionButtons, calculateIntrestButton, transactionsLabel, transactionsTextField,  transactionsButton, balanceLabel,  transactionHistoryArea
        );
        ...
        initialStage.show(); // show the user interface
